...
#[test]
fn a_base_override_swaps_the_voice_and_appends_the_context() {
    // The preamble override's composition: the base text replaces the
...
fn build_with_home_requires_a_home() {
    ...
    match build_with_home(None, BASE_PROMPT, &cwd, &Default::default()) {
